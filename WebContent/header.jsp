...
<body>
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #912338; color: white; padding: 5px;">
		<h2>Concordia Cart</h2>
		<h6>We specialize in electronics for Concordia students!</h6>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="cartDetails.jsp"
						style="margin: 0px; padding: 0px;" id="mycart"><i
							data-count="<%=notf%>"
							class="fa fa-shopping-cart fa-3x icon-white custom-badge"
