...
public class FansMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Message to Concordia Shopping Cart App</h2>" + ""
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("concordiashoppingcartapp@gmail.com", "Fans Message | " + name + " | " + email,
				htmlTextMessage);
