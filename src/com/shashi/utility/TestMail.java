	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Concordia Cart</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Concordia Cart.<br>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto $8.22 for the first product purchase. To avail this offer you only have "
